...
def main():
    ...
    def show_codes():  
        """Display language codes and their corresponding French names."""  
        print("Codes de langue Tesseract:")  
        for code, name in language_mapping.items():  
            print(f"{code}: {name}")  

    # Assuming 'args.show_langs' is a boolean indicating whether to show the languages  
    if args.show_langs:  
        show_codes()
...
if __name__ == '__main__':
    ...
    tess_path =  r"r'C:\Program Files\Tesseract-OCR\tesseract.exe'"  # Windows example
